...
=======
# SVJ s-channel Signal Request

JOs and codes for making validation plots for SVJ s-channel full signal grid request
...
```
cd existing_repo
git remote add origin https://gitlab.cern.ch/ebusch/svj-s-channel-signal-request.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.cern.ch/ebusch/svj-s-channel-signal-request/-/settings/integrations)
...
>>>>>>> b25e06110ba439cc05dd4c7863d0b8bd742634ac
